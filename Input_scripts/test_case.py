...
case_name = 'test_pbed' # Name of the input folder
...
r_pebbles = 3 # cm
fuels_dict = {'u_fuel1_pebble':{'name':'fuel1', 'pebbles_frac':0.5},
              'u_fuel2_pebble':{'name':'fuel2', 'pebbles_frac':0.2}}
...
# Discrete motion
if discrete_motion:
    Nrows_to_move = 0.01 #[20]*20+[10]*20+[5]*(Nsteps-20-20)
    time_per_pass = 100 # days

# DEM
else:
    positions_folder = '/global/scratch/users/yvesrobert/HTR-10/pebble_positions_larger/'
...
#%% Outputing
output_folder_name = 'test_case' # Name of the output folder
verbosity_mode = 1
