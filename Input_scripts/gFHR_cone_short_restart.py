...
case_name = 'gFHR_cone' # Name of the input folder
...
Nsteps = 2000
neutrons_per_cycle = [5000]*134 + [200000]*(Nsteps-134)
decay_step = 0 # days
...
# DEM
    ...
    positions_folder = '/global/scratch/users/yvesrobert/chrono_pbed_case/gFHR_cone/gFHR_cone0/settled/'
    DEM_step_increment = 1
    circulation_rate = 250190/(522/8) # pebbles/days
    DEM_circulation_step = 15011 # pebbles
    positions_scale = 100 #  m->cm
    positions_translation = [0,0, 0]
    DEM_start = 40
    DEM_end = 173
    DEM_files_prefix = 'filtered_step'
    import numpy as np
    base_reordering = np.loadtxt('/global/scratch/users/yvesrobert/HxF_dev/Models/gFHR_cone/base_reordering.txt', dtype=int)
    if looping:
    # Looper
        looper_Nr = 7
        looper_Nz = 15
...
#%% Outputing
output_folder_name = 'gFHR_dem_cone_short_restart' # Name of the output folder
verbosity_mode = 1
inventory_names = []
...
if restart_calculation:
    restart_step = 120
    restart_binary = '/global/scratch/users/yvesrobert/HxF_dev/Cases/gFHR_dem_cone_short/wrk_Serpent/input.wrk_120' #'/global/scratch/users/yvesrobert/HxF_dev/Cases/gFHR_dm_restart/wrk_Serpent/spectrum_restart/final_gFHR_dm_equilibrium.wrk'
    restart_data =   '/global/scratch/users/yvesrobert/HxF_dev/Cases/gFHR_dem_cone_short/Data/core_120.csv' #'/global/scratch/users/yvesrobert/HxF_dev/Cases/gFHR_dm_restart/Data/first_data.csv'
